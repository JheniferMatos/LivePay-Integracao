...
public class CommentControllerTest {
    ...
    public void testFindByInterested() throws Exception {
        ...
        mockMvc.perform(get("/comments?interested=true"))
                ...
                .andExpect(jsonPath("$[0].id").value(32L)) // Espera que o primeiro comentário tenha o ID 32
                .andExpect(jsonPath("$[0].author").value("Alice")) // Espera que o primeiro comentário tenha o autor Alice
                .andExpect(jsonPath("$[0].content").value("Eu gostei muito do seu produto")) // Espera que o primeiro comentário tenha o mesmo conteúdo do comment1
                .andExpect(jsonPath("$[0].interested").value(true)) // Espera que o primeiro comentário tenha a bandeira "interested" como verdadeira
                .andExpect(jsonPath("$[1].id").value(34L)) // Espera que o segundo comentário tenha o ID 34
                .andExpect(jsonPath("$[1].author").value("Carol")) // Espera que o segundo comentário tenha o autor Carol
                .andExpect(jsonPath("$[1].content").value("Eu quero saber mais sobre o seu produto")) // Espera que o segundo comentário tenha o mesmo conteúdo do comment3
                .andExpect(jsonPath("$[1].interested").value(true)); // Espera que o segundo comentário tenha a bandeira "interested" como verdadeira
        ...
        mockMvc.perform(get("/comments?interested=false"))
                ...
                .andExpect(jsonPath("$[0].author").value("Bob")) // Espera que o comentário tenha o autor Bob
                .andExpect(jsonPath("$[0].content").value("Eu não achei interessante")) // Espera que o comentário tenha o mesmo conteúdo do comment2
                .andExpect(jsonPath("$[0].interested").value(false)); // Espera que o comentário tenha a bandeira "interested" como falsa
    }
    ...
    public void testFindAll() throws Exception {
        ...
        mockMvc.perform(get("/comments"))
                ...
                .andExpect(jsonPath("$[0].content").value("Eu gostei muito do seu produto")) // Espera que o primeiro comentário tenha o mesmo conteúdo do comment1
                .andExpect(jsonPath("$[0].interested").value(true)) // Espera que o primeiro comentário tenha a bandeira "interested" como verdadeira
                .andExpect(jsonPath("$[1].id").value(33L)) // Espera que o segundo comentário tenha o ID 33
                .andExpect(jsonPath("$[1].author").value("Bob")) // Espera que o segundo comentário tenha o autor Bob
                .andExpect(jsonPath("$[1].content").value("Eu não achei interessante")) // Espera que o segundo comentário tenha o mesmo conteúdo do comment2
                .andExpect(jsonPath("$[1].interested").value(false)) // Espera que o segundo comentário tenha a bandeira "interested" como falsa
                .andExpect(jsonPath("$[2].id").value(34L)) // Espera que o terceiro comentário tenha o ID 34
                .andExpect(jsonPath("$[2].author").value("Carol")) // Espera que o terceiro comentário tenha o autor Carol
                .andExpect(jsonPath("$[2].content").value("Eu quero saber mais sobre o seu produto")) // Espera que o terceiro comentário tenha o mesmo conteúdo do comment3
                .andExpect(jsonPath("$[2].interested").value(true)); // Espera que o terceiro comentário tenha a bandeira "interested" como verdadeira
    }
    ...
    public void testIsInterested() throws Exception {
        ...
        // Simule o serviço para retornar os comentários com a bandeira "interested" definida pelo método isInterested
        ...
        // Execute uma solicitação POST com cada comentário e verifique se a bandeira "interested" está correta
        ...
        mockMvc.perform(post("/comments")
                ...
                .andExpect(status().isCreated()) // Espera um código de status 201
                .andExpect(content().contentType(MediaType.APPLICATION_JSON)) // Espera uma resposta em JSON
                .andExpect(jsonPath("$.interested").value(true)); // Espera que a bandeira "interested" seja verdadeira para o comentário positivo
        ...
        mockMvc.perform(post("/comments")
                ...
                .andExpect(status().isCreated()) // Espera um código de status 201
                .andExpect(content().contentType(MediaType.APPLICATION_JSON)) // Espera uma resposta em JSON
                .andExpect(jsonPath("$.interested").value(false)); // Espera que a bandeira "interested" seja falsa para o comentário negativo
        ...
        mockMvc.perform(post("/comments")
                ...
                .andExpect(status().isCreated()) // Espera um código de status 201
                .andExpect(content().contentType(MediaType.APPLICATION_JSON)) // Espera uma resposta em JSON
                .andExpect(jsonPath("$.interested").value(false)); // Espera que a bandeira "interested" seja falsa para o comentário neutro
    }
}
